...
public class GroupedTransaction {
    ...
    public void AtomicTransfer() throws Exception {
        ...
        final String account1_mnemonic = "All living beings in the universe are generated from the static force in the universe" +
                " the revolution of the solar system caused the force supreme";
        final String account2_mnemonic =  "All living beings in the universe are generated from the static force in the universe" +
                " the revolution of the solar system caused the force supreme";
        final String account3_mnemonic =  "All living beings in the universe are generated from the static force in the universe" +
                " the revolution of the solar system caused the force supreme";
