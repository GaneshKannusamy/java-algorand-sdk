...
public class TransactionEx {
    ...
    public void gettingStartedExample() throws Exception {
        ...
        final String PASSPHRASE = "turtle basket witness weird exile you fury expand husband question such salad guilt swap tower deer usage combine gun section aware picture magnet ability comfort";
